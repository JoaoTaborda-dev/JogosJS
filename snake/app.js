document.addEventListener('DOMContentLoaded', () => {
  ...
  function control(e) {
    ...
    if (e.keyCode === 39) {
      ...
      direction = -width // if we press the up arrow, the snake will go back ten divs
    } else if (e.keyCode === 37) {
      direction = -1 // if we press the left arrow on our keyboard, the snake will go left one div
